 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mi=new Km("@firebase/app"),ID="@firebase/app-compat",SD="@firebase/analytics-compat",RD="@firebase/analytics",AD="@firebase/app-check-compat",kD="@firebase/app-check",CD="@firebase/auth",PD="@firebase/auth-compat",xD="@firebase/database",DD="@firebase/database-compat",ND="@firebase/functions",OD="@firebase/functions-compat",bD="@firebase/installations",LD="@firebase/installations-compat",MD="@firebase/messaging",VD="@firebase/messaging-compat",FD="@firebase/performance",UD="@firebase/performance-compat",$D="@firebase/remote-config",jD="@firebase/remote-config-compat",zD="@firebase/storage",BD="@firebase/storage-compat",HD="@firebase/firestore",WD="@firebase/firestore-compat",qD="firebase",KD="10.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oN(t){Vi(new Xr("platform-logger",e=>new ED(e),"PRIVATE")),Vi(new Xr("heartbeat",e=>new rN(e),"PRIVATE")),jn(up,k_,t),jn(up,k_,"esm2017"),jn("fire-js","")}oN("");var aN="firebase",lN="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc=new Km("@firebase/auth");function cN(t,...e){dc.logLevel<=le.WARN&&dc.warn(`Auth (${Gi}): ${t}`,...e)}function ku(t,...e){dc.logLevel<=le.ERROR&&dc.error(`Auth (${Gi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cl{constructor(e,n){this.shortDelay=e,this.longDelay=n,fr(n>e,"Short delay should be less than long delay!"),this.isMobile=zx()||Wx()}get(){return fN()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nd(t,e){return hl(t,"POST","/v1/accounts:signInWithPassword",Qi(t,e))}async function HN(t,e){return ii(t,"POST","/v1/accounts:sendOobCode",Qi(t,e))}async function Od(t,e){return HN(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WN(t,e){return hl(t,"POST","/v1/accounts:signInWithEmailLink",Qi(t,e))}async function qN(t,e){return hl(t,"POST","/v1/accounts:signInWithEmailLink",Qi(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PT(t,e,n=!1){const r="signIn",i=await CT(t,r,e),s=await Ui._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function JN(t,e){return PT(si(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UT{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return E2;case"linkViaPopup":case"linkViaRedirect":return I2;case"reauthViaPopup":case"reauthViaRedirect":return T2;default:cn(this.auth,"internal-error")}}resolve(e){fr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){fr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(e,n="asc"){this.field=e,this.dir=n}}function eM(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function F4(){const t=Ki(),e=async()=>{confirm("로그아웃 하시겠습니까?")&&(await kn.signOut(),t("/create-account"))};return A.jsxs(M4,{children:[A.jsxs(V4,{children:[A.jsx(Xf,{to:"/",children:A.jsx(Xd,{children:A.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor",className:"w-5 h-5",children:A.jsx("path",{fillRule:"evenodd",d:"M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z",clipRule:"evenodd"})})})}),A.jsx(Xf,{to:"/profile",children:A.jsx(Xd,{children:A.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor",className:"w-5 h-5",children:A.jsx("path",{d:"M10 8a3 3 0 100-6 3 3 0 000 6zM3.465 14.493a1.23 1.23 0 00.41 1.412A9.957 9.957 0 0010 18c2.31 0 4.438-.784 6.131-2.1.43-.333.604-.903.408-1.41a7.002 7.002 0 00-13.074.003z"})})})}),A.jsx(Xd,{onClick:e,className:"log-out",children:A.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor",className:"w-5 h-5",children:[A.jsx("path",{fillRule:"evenodd",d:"M3 4.25A2.25 2.25 0 015.25 2h5.5A2.25 2.25 0 0113 4.25v2a.75.75 0 01-1.5 0v-2a.75.75 0 00-.75-.75h-5.5a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h5.5a.75.75 0 00.75-.75v-2a.75.75 0 011.5 0v2A2.25 2.25 0 0110.75 18h-5.5A2.25 2.25 0 013 15.75V4.25z",clipRule:"evenodd"}),A.jsx("path",{fillRule:"evenodd",d:"M19 10a.75.75 0 00-.75-.75H8.704l1.048-.943a.75.75 0 10-1.004-1.114l-2.5 2.25a.75.75 0 000 1.114l2.5 2.25a.75.75 0 101.004-1.114l-1.048-.943h9.546A.75.75 0 0019 10z",clipRule:"evenodd"})]})})]}),A.jsx(wP,{})]})}const U4=z.div`
  height: 100vh;
  display: flex;
  justify-content: center;
  align-items: center;
...
`;function Ry(){return A.jsx(K4,{children:A.jsx("p",{children:"Momen+we+"})})}function G4(){const t=Ki(),[e,n]=C.useState(""),r=s=>{const{target:{value:o}}=s;n(o)},i=async s=>{if(s.preventDefault(),e!=="")try{await ZN(kn,e),t("/login")}catch(o){console.log(o)}};return A.jsxs(Sy,{children:[A.jsx(io,{children:A.jsxs(Ty,{children:[A.jsx(B4,{className:"nomargin",children:"내 계정 찾기"}),A.jsx(W4,{children:"비밀번호를 변경하려면 계정에 연결된 이메일을 입력해주세요."}),A.jsxs(Iy,{onSubmit:i,children:[A.jsx(or,{onChange:r,name:"email",placeholder:"이메일",type:"email",required:!0}),A.jsx(or,{type:"submit",value:"발송"})]})]})}),A.jsx(io,{children:A.jsx(Ry,{})})]})}const Q4=z.form`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Y4=z.textarea`
...
`,fF=z.button`
  ...
  text-transform: uppercase;
  cursor: pointer;
`;function CR({userId:t,username:e,photo:n,tweet:r,id:i}){const[s,o]=C.useState(!1),a=kn.currentUser,l=async()=>{if(!(!confirm("Are you sure you want to delete this tweet?")||(a==null?void 0:a.uid)!==t))try{if(await D4(oy(xl,"tweets",i)),n){const h=Fa(Za,`tweets/${a.uid}/${i}`);await rI(h)}}catch(h){console.log(h)}finally{}},u=()=>o(c=>!c);return A.jsxs(aF,{children:[A.jsxs(X0,{children:[A.jsx(uF,{children:e}),s?A.jsx(oF,{tweet:r,photo:n,id:i,setIsEditing:u}):A.jsx(cF,{children:r}),(a==null?void 0:a.uid)===t?A.jsxs(hF,{children:[A.jsx(dF,{onClick:l,children:"삭제"}),A.jsx(fF,{onClick:u,children:s?"취소":"수정"})]}):null]}),n?A.jsx(X0,{children:A.jsx(lF,{src:n})}):null]})}const pF=z.div`
  overflow-y: auto;
  display: flex;
  flex-direction: column;
  gap: 10px;
...
`,DF=z.img`
  height: 18px;
`;function PR({page:t}){const e=Ki(),n=["google","github"],r=async i=>{i.preventDefault();const{name:s}=i.currentTarget;try{const o=s==="github"?new er:new Zn;await R2(kn,o),e("/home")}catch(o){console.error(o)}};return A.jsx(PF,{children:n.map(i=>A.jsxs(xF,{name:i,onClick:r,children:[A.jsx(DF,{src:`${i}-logo.svg`}),i.charAt(0).toUpperCase()+i.slice(1)," 계정으로"," ",t==="login"?"로그인":"가입하기"]},i))})}function NF(){const t=Ki(),[e,n]=C.useState(!1),[r,i]=C.useState(""),[s,o]=C.useState(""),[a,l]=C.useState(""),u=d=>{const{target:{name:p,value:v}}=d;p==="email"?i(v):p==="password"&&o(v)},c=async d=>{if(d.preventDefault(),l(""),!(e||r===""||s===""))try{n(!0),await t2(kn,r,s),t("/")}catch(p){p instanceof hn&&l(p.message)}finally{n(!1)}},h=d=>{d.preventDefault(),t("/forgot-password")};return A.jsxs(Sy,{children:[A.jsx(io,{children:A.jsxs(Ty,{children:[A.jsx(PR,{page:"login"}),A.jsx(kR,{children:A.jsx("span",{children:"또는"})}),A.jsxs(Iy,{onSubmit:c,children:[A.jsx(or,{onChange:u,name:"email",value:r,placeholder:"이메일",type:"email",required:!0}),A.jsx(or,{onChange:u,name:"password",value:s,placeholder:"비밀번호",type:"password",required:!0}),A.jsx(or,{type:"submit",value:e?"로그인중...":"로그인"})]}),a!==""?A.jsx(RR,{children:a}):null,A.jsx(AR,{children:A.jsx(q4,{onClick:h,children:"비밀번호를 잊으셨나요?"})})]})}),A.jsx(io,{children:A.jsx(Ry,{})})]})}function OF(){const t=Ki(),[e,n]=C.useState(!1),[r,i]=C.useState(""),[s,o]=C.useState(""),[a,l]=C.useState(""),[u,c]=C.useState(""),h=p=>{const{target:{name:v,value:_}}=p;v==="name"?i(_):v==="email"?o(_):v==="password"&&l(_)},d=async p=>{if(p.preventDefault(),c(""),!(e||r===""||s===""||a===""))try{n(!0);const v=await e2(kn,s,a);await fp(v.user,{displayName:r}),t("/home")}catch(v){v instanceof hn&&c(v.message)}finally{n(!1)}};return A.jsxs(Sy,{children:[A.jsx(io,{children:A.jsxs(Ty,{children:[A.jsx(PR,{page:"register"}),A.jsx(kR,{children:A.jsx("span",{children:"또는"})}),A.jsxs(Iy,{onSubmit:d,children:[A.jsx(or,{onChange:h,name:"name",value:r,placeholder:"이름",type:"text",required:!0}),A.jsx(or,{onChange:h,name:"email",value:s,placeholder:"이메일",type:"email",required:!0}),A.jsx(or,{onChange:h,name:"password",value:a,placeholder:"비밀번호",type:"password",required:!0}),A.jsx(or,{type:"submit",value:e?"계정 생성중...":"계정 만들기"})]}),u!==""?A.jsx(RR,{children:u}):null,A.jsxs(AR,{children:[A.jsx(H4,{children:"이미 가입하셨나요?"}),A.jsx(Xf,{to:"/login",children:"로그인"})]})]})}),A.jsx(io,{children:A.jsx(Ry,{})})]})}const bF=kP([{path:"/",element:A.jsx(z4,{children:A.jsx(F4,{})}),children:[{path:"",element:A.jsx(yF,{})},{path:"profile",element:A.jsx(CF,{})}]},{path:"/create-account",element:A.jsx(OF,{})},{path:"/login",element:A.jsx(NF,{})},{path:"/forgot-password",element:A.jsx(G4,{})}]),LF=W1`
  ${K1};

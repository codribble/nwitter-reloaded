...
`;function F4(){const t=Ki(),e=async()=>{confirm("Are you sure you want to log out?")&&(await kn.signOut(),t("/create-account"))};return A.jsxs(M4,{children:[A.jsxs(V4,{children:[A.jsx(Xf,{to:"/home",children:A.jsx(Xd,{children:A.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor",className:"w-5 h-5",children:A.jsx("path",{fillRule:"evenodd",d:"M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z",clipRule:"evenodd"})})})}),A.jsx(Xf,{to:"/profile",children:A.jsx(Xd,{children:A.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor",className:"w-5 h-5",children:A.jsx("path",{d:"M10 8a3 3 0 100-6 3 3 0 000 6zM3.465 14.493a1.23 1.23 0 00.41 1.412A9.957 9.957 0 0010 18c2.31 0 4.438-.784 6.131-2.1.43-.333.604-.903.408-1.41a7.002 7.002 0 00-13.074.003z"})})})}),A.jsx(Xd,{onClick:e,className:"log-out",children:A.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor",className:"w-5 h-5",children:[A.jsx("path",{fillRule:"evenodd",d:"M3 4.25A2.25 2.25 0 015.25 2h5.5A2.25 2.25 0 0113 4.25v2a.75.75 0 01-1.5 0v-2a.75.75 0 00-.75-.75h-5.5a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h5.5a.75.75 0 00.75-.75v-2a.75.75 0 011.5 0v2A2.25 2.25 0 0110.75 18h-5.5A2.25 2.25 0 013 15.75V4.25z",clipRule:"evenodd"}),A.jsx("path",{fillRule:"evenodd",d:"M19 10a.75.75 0 00-.75-.75H8.704l1.048-.943a.75.75 0 10-1.004-1.114l-2.5 2.25a.75.75 0 000 1.114l2.5 2.25a.75.75 0 101.004-1.114l-1.048-.943h9.546A.75.75 0 0019 10z",clipRule:"evenodd"})]})})]}),A.jsx(wP,{})]})}const U4=z.div`
  height: 100vh;
  display: flex;
  justify-content: center;
  align-items: center;
...
`;function Ry(){return A.jsx(K4,{children:A.jsx("p",{children:"Momen+we+"})})}function G4(){const t=Ki(),[e,n]=C.useState(""),r=s=>{const{target:{value:o}}=s;n(o)},i=async s=>{s.preventDefault(),e!==""&&(await ZN(kn,e),t("/"))};return A.jsxs(Sy,{children:[A.jsx(io,{children:A.jsxs(Ty,{children:[A.jsx(B4,{className:"nomargin",children:"내 계정 찾기"}),A.jsx(W4,{children:"비밀번호를 변경하려면 계정에 연결된 이메일을 입력해주세요."}),A.jsxs(Iy,{onSubmit:i,children:[A.jsx(or,{onChange:r,name:"email",placeholder:"이메일",type:"email",required:!0}),A.jsx(or,{type:"submit",value:"발송"})]})]})}),A.jsx(io,{children:A.jsx(Ry,{})})]})}const Q4=z.form`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Y4=z.textarea`
